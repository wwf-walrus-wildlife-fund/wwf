...
import { Upload, FileText, X, Clock, Info, CheckCircle2, Loader2, Database } from "lucide-react";
    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center pt-16 px-4">
        ...
        >
          ...
          <h2 className="text-white mb-3" style={{ fontSize: "1.5rem" }}>Dataset Published</h2>
          <p className="text-white/35 mb-2">
            Your data has been encrypted and stored on Walrus for {storageDays} days.
          </p>
    ...
    <div className="relative min-h-screen pt-24 pb-16 px-4">
      ...
      <div className="max-w-3xl mx-auto">
        <motion.div
          ...
          className="mb-10"
        >
          <h1 className="text-white mb-2" style={{ fontSize: "2rem" }}>Upload Data</h1>
          <p className="text-white/30">Monetize your datasets on the decentralized marketplace.</p>
        </motion.div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            >
              ...
              />
              <Upload className={`w-8 h-8 mx-auto mb-4 transition-colors ${dragOver ? "text-[#a29bfe]" : "text-white/15"}`} />
              <p className="text-white/40 mb-1">
                Drop files here or <span className="text-[#a29bfe] cursor-pointer">browse</span>
              </p>
                ...
                {files.map((file, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-white/70 truncate" style={{ fontSize: "0.85rem" }}>{file.name}</p>
                      <p className="text-white/20" style={{ fontSize: "0.7rem" }}>{formatSize(file.size)}</p>
                    </div>
                    <button
          ...
          >
            ...
            <div>
              <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Description</label>
              <textarea
                value={description}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Category</label>
                <select
                  value={category}
                ...
                >
                  {["AI Training", "Financial", "Healthcare", "Geospatial", "Social", "IoT"].map((c) => (
                    <option key={c} value={c}>{c}</option>
                  ))}
                </select>
              </div>
              <div>
                <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Tags</label>
                <input
                  type="text"
                  value={tags}
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-3">
                <span className="text-white/30" style={{ fontSize: "0.8rem" }}>Duration</span>
                <span className="text-[#a29bfe] tabular-nums" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                  {storageDays} days
                </span>
              </div>
              <input
                ...
                className="w-full"
              />
              <div className="flex justify-between mt-2 text-white/15" style={{ fontSize: "0.7rem" }}>
                <span>14 days</span>
                <span>365 days</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 p-3 rounded-lg bg-[#6C5CE7]/5 border border-[#6C5CE7]/10">
              ...
              <span className="text-[#a29bfe]/50" style={{ fontSize: "0.75rem" }}>
                Estimated storage cost: ~{storageCost} SUI &middot; Stored on Walrus
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Buy Price (SUI)</label>
                <input
                  type="number"
                  value={price}
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white/50" style={{ fontSize: "0.85rem" }}>Enable rental pricing</span>
              </div>
              ...
              {rentEnabled && (
                <motion.div
                  ...
                  exit={{ opacity: 0, height: 0 }}
                >
                  <label className="block text-white/30 mb-1.5" style={{ fontSize: "0.8rem" }}>Rent Price (SUI/day)</label>
                  <input
                    type="number"
                    value={rentPrice}
          ...
          >
            ...
            <p className="text-center text-white/15 mt-3" style={{ fontSize: "0.75rem" }}>
